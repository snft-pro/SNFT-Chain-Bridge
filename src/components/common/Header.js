...
const HeaderNew = () => {
    ...
    useEffect(() => {
        if (chain?.id == 12012 || chain?.id == 84532) {
        ...
        <>
            <header className='app_header'>
                <Navbar expand="lg" variant="dark">
                    <Container fluid>
                        <Link 
                        style={{marginLeft:"100px"}}to="/" className='app_logo'>
                        ...
                        <Navbar.Collapse id="navbarScroll">
                            ...
                            <div className='right_header_wrap'>
                                ...
                                <div style={{marginRight:"100px"}}  className='dropdown_wrap'>
                                    {checkMetaMask === true ? <a className='btn disconnect_btn header_btn' href='https://metamask.io/' target='_blank'><Image src={metamask} alt="metamask icn" fluid /> Please Install Metamask Wallet</a> : address ? <Dropdown>
                                        ...
                                        <Dropdown.Menu>
                                            ...
                                            <Dropdown.Item as={Link} to="/account/deposit"><AiOutlineDownload /> History</Dropdown.Item>
